...
SSH Onboard handles sensitive SSH onboarding workflows. Please report suspected vulnerabilities privately.

## Supported versions

The project has not published a stable release yet. Security fixes will target the latest released version once public releases begin.
